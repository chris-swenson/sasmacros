%macro SaveLog(name,dir,format=) / des='Save the log';
    ...
    /* REVISION 2012-04-20 CAS: Added rule to switch DT to T and to output an issue
       for incorrect values of the FORMAT argument. */
    %if "&format"="" %then %do;
        %let dtext=;
    ...
    %else %do;
        ...
        data _null_;
            ...
            /* Set date according to specified format */
                ...
                put "%str(E)RROR: %str(I)nvalid FORMAT argument. Please use DT, T, D, M, Q, or Y.";
            end;
